    ...
    return (
        <SafeAreaView className="flex-1 bg-base1">
            ...
            >
                ...
                >
                    <View className="flex-1 items-center px-[10%] pt-[20%]">
                        <Card width={200} height={200}/>
                        <Text className="text-texto1 text-4xl font-vs-bold mt-20">Crear Cuenta</Text>
                        <View className="w-full py-10 gap-5 items-center">
                            ...
                            <View className="flex flex-row border border-texto1 w-full rounded-xl py-2 px-5 items-center">
                                ...
                                <Pressable className="w-1/12" onPress={() => setShowPassword1(!showPassword1)}>
                                {showPassword1 ? (
                            ...
                            <View className="flex-row gap-2">
                                <Text className="text-texto2 font-vs-lighttext">Ya tienes cuenta?</Text>
                                <Text className="text-blue-400 font-vs-lighttext underline" onPress={Iniciar}>Iniciar Sesion</Text>
                            </View>
                        </View>
                    </View>
                </ScrollView>
